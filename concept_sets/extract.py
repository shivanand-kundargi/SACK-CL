...
# Example usage
json_file = '/p/lustre1/kundargi1/SACK/concept_sets/descriptors_inaturalist1000.json'  # Replace with your actual JSON file path
...
inaturalist=list(range(300))
for i in range(len(inaturalist)//n_exp):
    curr_lst=[]
    curr_lst.append(inaturalist[0:(i+1)*n_exp])
    print("Current list:", curr_lst)
    selected_values = get_values_from_json(json_file, curr_lst[0])
    # print("Selected values:", selected_values)
    file_path = f"/p/lustre1/kundargi1/SACK/concept_sets/inaturalist_300_concept_sets/new_exp{i+1}_filtered_new.txt"
