...
#         --permute_classes=True \
#         --seed=$seed \
#         --ckpt_name=icarl-cifar100-original-run-seed-$seed \
#         # --device='0,1,2,3' \
#         # --distributed="dp" \
...
#         --permute_classes=True \
#         --seed=$seed \
#         --ckpt_name=gem-cifar100-original-run-seed-$seed \
#         # --device='0,1,2,3' \
#         # --distributed="dpp" \
...
#         --permute_classes=True \
#         --seed=$seed \
#         --ckpt_name=der-cifar100-original-run-seed-$seed \
#         # --device='0,1,2,3' \
#         # --distributed="dp" \       
...
#         --permute_classes=True \
#         --seed=$seed \
#         --ckpt_name=bic-cifar100-original-run-seed-$seed \
#         # --device='0,1,2,3' \
#         # --distributed="dp" \      
...
#         --permute_classes=True \
#         --seed=$seed \
#         --ckpt_name=gss-cifar100-original-run-seed-$seed \
#         # --device='0,1,2,3' \
#         # --distributed="dp" \      
...
#         --permute_classes=True \
#         --seed=$seed \
#         --ckpt_name=mer-cifar100-original-run-seed-$seed \
#         # --device='0,1,2,3' \
#         # --distributed="dp" \ 
...
#         --permute_classes=True \
#         --seed=$seed \
#         --ckpt_name=daulprompt-cifar100-original-run-seed-$seed \
#         # --device='0,1,2,3' \
#         # --distributed="dp" \       
