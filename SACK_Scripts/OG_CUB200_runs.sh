...
# #         --permute_classes=True \
# #         --seed=$seed \
# #         --ckpt_name=icarl-cub200-original-run-seed-$seed \
# #         # --device='0,1,2,3' \
# #         # --distributed="dp" \
...
#         --permute_classes=True \
#         --seed=$seed \
#         --ckpt_name=er-cub200-original-run-seed-$seed \
#         --device='0,1' \
#         --distributed="dp"      
...
# #         --permute_classes=True \
# #         --seed=$seed \
# #         --ckpt_name=derpp-cub200-original-run-seed-$seed \
# #         # --device='0,1,2,3' \
# #         # --distributed="dp" \       
...
#         --permute_classes=True \
#         --seed=$seed \
#         --ckpt_name=bic-cub200-original-run-seed-$seed \
#         # --device='0,1,2,3' \
#         # --distributed="dp" \      
...
#         --permute_classes=True \
#         --seed=$seed \
#         --ckpt_name=gss-cub200-original-run-seed-$seed \
#         # --device='0,1,2,3' \
#         # --distributed="dp" \      
...
#         --permute_classes=True \
#         --seed=$seed \
#         --ckpt_name=hal-cub200-original-run-seed-$seed \
#         # --device='0,1,2,3' \
#         # --distributed="dp" \
...
#         --permute_classes=True \
#         --seed=$seed \
#         --ckpt_name=mer-cub200-original-run-seed-$seed \
#         # --device='0,1,2,3' \
#         # --distributed="dp" \ 
...
#         --permute_classes=True \
#         --seed=$seed \
#         --ckpt_name=codaprompt-cub200-original-run-seed-$seed \
#         # --device='0,1,2,3' \
#         # --distributed="dp" \       
...
#         --permute_classes=True \
#         --seed=$seed \
#         --ckpt_name=daulprompt-cub200-original-run-seed-$seed \
#         # --device='0,1,2,3' \
#         # --distributed="dp" \       
...
#         --permute_classes=True \
#         --seed=$seed \
#         --ckpt_name=dap-cub200-original-run-seed-$seed  \
#         # --device='0,1,2,3' \
#         # --distributed="dp" \        
