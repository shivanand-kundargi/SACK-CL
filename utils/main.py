...
os.environ["TRANSFORMERS_CACHE"] = os.path.join(base_path, ".cache/huggingface")
os.environ["CLIP_CACHE"] = os.path.join(base_path, ".cache/clip")

# Ensure the base path exists
os.makedirs(base_path, exist_ok=True)
os.makedirs(os.environ["TORCH_HOME"], exist_ok=True)
os.makedirs(os.environ["TRANSFORMERS_CACHE"], exist_ok=True)
os.makedirs(os.environ["CLIP_CACHE"], exist_ok=True)
import sys
import time
import importlib
import socket
